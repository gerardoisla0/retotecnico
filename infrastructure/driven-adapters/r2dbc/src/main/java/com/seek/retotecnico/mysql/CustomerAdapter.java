...
public class CustomerAdapter implements CustomerGateway {
    ...
    @Override
    public Mono<Customer> findCustomerByDocumentId(String documentId) {
    ...
    public Mono<Customer> createCustomer(Customer customer) {
        return Mono.just(customer)
                ...
                .map(CustomerMapper.MAPPER::dataToDomain)
                .doOnSubscribe(subscription -> log.info(CREATE_CUSTOMERS_REQUEST, kv(CREATE_CUSTOMERS_KEY_REQUEST, customer)))
