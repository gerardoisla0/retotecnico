...
public class UpdateTaskHandler {
    ...
    private final UpdateTaskProcess updateTaskProcess;

    private static final String OPERATION_PROCESS_NAME = "updateTask";
    ...
    public Mono<ServerResponse> process(ServerRequest request) {
        ...
        return request.bodyToMono(SeekRequestApi.class)
                .flatMap(task -> {
                    return updateTaskProcess.execute(taskId, task, Operation.UPDATE_TASK);
                });
    }
