...
import com.seek.retotecnico.api.processor.SaveTaskProcess;
...
public class SaveTaskHandler {

    private final SaveTaskProcess saveTaskProcess;

    private static final String OPERATION_PROCESS_NAME = "createTask";
    ...
    public Mono<ServerResponse> process(SeekRequestApi seekRequestApi) {
        return saveTaskProcess.execute(seekRequestApi, Operation.CREATE_TASK);
    }
